...
trait IconTrait {
  ...
  {
    return [
	"flaticon-think" => "flat-think",
	"flaticon-project" => "flat-project",
	"flaticon-time" => "flat-time",
	"flaticon-startup" => "flat-startup",
	"flaticon-campaign" => "flat-campaign",
	"flaticon-list" => "flat-list",
	"flaticon-research" => "flat-research",
	"flaticon-result" => "flat-result",
	"flaticon-team" => "flat-team",
	"flaticon-quote" => "flat-quote",
	"flaticon-pen" => "flat-pen",
	"flaticon-search" => "flat-search",
	"flaticon-phone" => "flat-phone",
	"flaticon-placeholder" => "flat-placeholder",
	"flaticon-plane" => "flat-plane",
	"flaticon-telephone" => "flat-telephone",
	"flaticon-rocket" => "flat-rocket",
	"flaticon-speaker" => "flat-speaker",
	"flaticon-next" => "flat-next",
	"flaticon-chart" => "flat-chart",
	"flaticon-graph" => "flat-graph",
	"flaticon-filter" => "flat-filter",
	"flaticon-research-1" => "flat-research-1",
	"flaticon-think-1" => "flat-think-1",
	"flaticon-growth" => "flat-growth",
	"flaticon-portfolio" => "flat-portfolio",
	"flaticon-origami" => "flat-origami",
	"flaticon-aircraft" => "flat-aircraft",
	"flaticon-plane-1" => "flat-plane-1",
	"flaticon-shout" => "flat-shout",
	"flaticon-growth-1" => "flat-growth-1",
	"flaticon-marketing" => "flat-marketing",
	"flaticon-responsive-design" => "flat-responsive-design",
	"flaticon-layers" => "flat-layers",
	"flaticon-clean" => "flat-clean",
	"flaticon-idea" => "flat-idea",
	"flaticon-project-1" => "flat-project-1",
	"flaticon-smile" => "flat-smile",	
	"flaticon-review" => "flat-review",
	"flaticon-award" => "flat-award",
	"flaticon-download" => "flat-download",
	"flaticon-fingerprint" => "flat-fingerprint",
	"flaticon-safe" => "flat-safe",
	"flaticon-shield" => "flat-shield",
	"flaticon-pen-1" => "flat-pen-1",
	"flaticon-clean-1" => "flat-clean-1",
	"flaticon-null" => "flat-null",	
	"flaticon-internet" => "flat-internet",
	"flaticon-support" => "flat-support",
	"flaticon-responsive" => "flat-responsive",
	"flaticon-hand" => "flat-hand",
	"flaticon-canvas" => "flat-canvas",
	"flaticon-goal" => "flat-goal",
	"flaticon-innovation" => "flat-innovation",
	"flaticon-mail" => "flat-mail",	
	"flaticon-share" => "flat-share",
	"flaticon-marker" => "flat-marker",
	"flaticon-user-experience" => "flat-user-experience",
	"flaticon-layers-1" => "flat-layers-1",
	"flaticon-click" => "flat-click",
	"flaticon-login" => "flat-login",
	"flaticon-design" => "flat-design",
	"flaticon-dashboard" => "flat-dashboard",
	"flaticon-back" => "flat-back",
