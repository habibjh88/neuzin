...
if ( !function_exists( 'neuzin_enqueue_scripts' ) ) {
	function neuzin_enqueue_scripts() {
		...
		// Style CSS
		wp_enqueue_style( 'neuzin-style',     	neuzin_get_maybe_rtl('style.css'), array(), NEUZIN_VERSION );
		
		// Template Style
		wp_add_inline_style( 'neuzin-style',   	neuzin_template_style() );
		...
		wp_enqueue_script( 'neuzin-main',    	NEUZIN_JS_URL . 'main.js', $dep , NEUZIN_VERSION, true );
