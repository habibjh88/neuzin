jQuery(document).ready(function ($) {
    ...
    /* Sticky Menu */
    if (neuzinObj.stickyMenu == 1 || neuzinObj.stickyMenu == 'on') {
    ...
    if (typeof $.fn.magnificPopup == 'function') {
        if ($('.zoom-gallery').length) {
            $('.zoom-gallery').each(function () { // the containers for all your galleries
                $(this).magnificPopup({
                    delegate: 'a.neuzin-popup-zoom', // the selector for gallery item
                    type: 'image',
                    gallery: {
                        enabled: true
                    }
...
function neuzin_load_content_area_scripts($) {
...
function neuzin_content_load_scripts() {
    ...
    After Load All Content Add a Class In Body
    -------------------------------------*/
    $(window).on('load', neuzin_page_loaded);
    neuzin_page_loaded();
...
window.neuzin_page_loaded = function () {
