...
$id            			= get_the_id();
$excerpt_count			= NeuzinTheme::neuzin_options('excerpt_display_limit');
...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'rt-el-service-grid-1' ); ?>>
	<div class="rtin-item <?php echo esc_attr( $icon_class ); ?>">
		<div class="rtin-content">
			...
			<?php if ( NeuzinTheme::neuzin_options('excerpt_display') ) { ?>
				<p><?php echo wp_kses_post( $excerpt );?></p>
			<?php } ?>
			<?php if ( NeuzinTheme::neuzin_options('read_display') ) { ?>
			<div class="rtin-read">
				<a class="button-1" href="<?php the_permalink(); ?>">
					<?php echo esc_html( NeuzinTheme::neuzin_options('service_readmore_text') );?>
