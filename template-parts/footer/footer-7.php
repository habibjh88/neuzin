<?php
$neuzin_footer_column = NeuzinTheme::neuzin_options('footer_column_7');
...
$neuzin_footer7_topshap = empty( NeuzinTheme::neuzin_options('footer7_top_shape')['url'] ) ? NEUZIN_IMG_URL . 'element76.png' : NeuzinTheme::neuzin_options('footer7_top_shape')['url'];
// Logo
