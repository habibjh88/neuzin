...
if ( NeuzinTheme::neuzin_options('services_style') == 'style1' ){
	$sercices_archive_layout = "service-default service-grid-layout1";
	$template 				 = 'services-1';
}elseif( NeuzinTheme::neuzin_options('services_style') == 'style2' ){
	$sercices_archive_layout = "service-default service-grid-layout2";
	$template 				 = 'services-2';
}elseif( NeuzinTheme::neuzin_options('services_style') == 'style3' ){
