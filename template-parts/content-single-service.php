...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'service-single' ); ?>>
	<div class="single-service-inner">
		...
		<?php } ?>		
		<?php if ( ( Theme::neuzin_options('service_contact') ) && !empty ( $neuzin_service_contact ) || ( Theme::neuzin_options('service_email') ) && !empty ( $neuzin_service_email ) ) { ?>
		<ul class="rtin-service-info">			
			<?php if ( ( Theme::neuzin_options('service_contact') ) && !empty ( $neuzin_service_contact ) ) { ?>
				<li><span class="rtin-label"><?php esc_html_e( 'Contact', 'neuzin' );?> :</span><?php echo wp_kses_post( $neuzin_service_contact );?></li>
			<?php } if ( ( Theme::neuzin_options('service_email') ) && !empty ( $neuzin_service_email ) ) { ?>
				<li><span class="rtin-label"><?php esc_html_e( 'E-mail', 'neuzin' );?> :</span><?php echo wp_kses_post( $neuzin_service_email );?></li>
			<?php } ?>
		</ul>
		<?php } ?>			
		<?php the_content(); ?>
		<?php if ( ( Theme::neuzin_options('service_button') ) && !empty ( $neuzin_service_button ) ) { ?>
