...
$neuzin_has_entry_meta  = ( ( !has_post_thumbnail() && Theme::neuzin_options('blog_date') ) || Theme::neuzin_options('blog_author_name') || Theme::neuzin_options('blog_comment_num') || Theme::neuzin_options('blog_cats') ) ? true : false;

$neuzin_has_entry_meta2  = ( Theme::neuzin_options('blog_author_name') || Theme::neuzin_options('blog_comment_num') || Theme::neuzin_options('blog_cats') ) ? true : false;
...
$content = wp_trim_words( $content, Theme::neuzin_options('post_content_limit'), '' );	
?>
	...
	<div class="blog-box">
		...
		<div class="blog-content-holder">
			...
			<ul>
				...
				<?php } ?>
				<?php if ( Theme::neuzin_options('blog_date') ) { ?>
				<li><?php if ( !has_post_thumbnail() && ( Theme::neuzin_options('display_no_preview_image') == 'off'  ) ) { ?>
