			...
			<div class="menu-right-wrap header-icon-area">
				...
				<div class="header-button-wrap">
					<div class="header-button">
						<?php if ( NeuzinTheme::neuzin_options('online_button_text') ) { ?><a class="btn-fill btn-gradient" target="_self" href="<?php echo esc_url( NeuzinTheme::neuzin_options('online_button_link')  );?>"><?php echo esc_html( NeuzinTheme::neuzin_options('online_button_text') );?></a><?php } ?>
					</div>
				</div>
				<?php } ?>
			</div>
	...
	<div class="container">
		<div class="sticky-menu-align">
			...
			<div class="menu-right-wrap header-icon-area">
				...
				<div class="header-button-wrap">
					<div class="header-button">
						<a class="btn-fill btn-gradient" target="_self" href="<?php echo esc_url( NeuzinTheme::neuzin_options('online_button_link')  );?>"><?php echo esc_html( NeuzinTheme::neuzin_options('online_button_text') );?></a>
					</div>
				</div>
				<?php } ?>
			</div>
