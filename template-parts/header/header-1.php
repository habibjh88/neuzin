...
$neuzin_header_action  = ( NeuzinTheme::neuzin_options('search_icon') || NeuzinTheme::neuzin_options('cart_icon') || NeuzinTheme::neuzin_options('online_button') == '1' || NeuzinTheme::neuzin_options('vertical_menu_icon') && has_nav_menu( 'topright' ) ) ? true : false;
	...
	<div class="container">
		<div class="menu-full-wrap">
			...
			<div class="menu-right-wrap header-icon-area">
				...
				<?php } ?>
				<?php if ( NeuzinTheme::neuzin_options('vertical_menu_icon') && has_nav_menu( 'topright' ) ) { ?>
